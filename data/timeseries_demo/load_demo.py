...
for ts_name in [TS_FULL, TS_180]:
    if fots.TimeSeries.exists(ts_name):
        fots.TimeSeries.delete(ts_name)
...
ts_full = fots.TimeSeries.from_csv(
    name=TS_FULL,
    filepath=CSV_PATH,
    timestamp_col="timestamp",
)
fots.TimeSeries.link_sample(sample_full._id, TS_FULL)
...
ts_180._name = TS_180
ts_180.save()
fots.TimeSeries.link_sample(sample_180._id, TS_180)
